...
int booking()
  ...
  int AC_price;
    ...
    scanf("%s",&details_hotel.hotel_name);
    
    printf("Enter location");
    scanf("%s",&details_hotel.location);
    
    printf("Enter Hotel Name");
    scanf("%d",&details_hotel.NON_AC_price);

    printf("Enter AC_price");
    scanf("%s",&details_hotel.AC_price);
    ...
    void feedback()
    {
        char review_feedback[50];
        char hotel_namee[50];
        printf("enter hotel name\n");
        scanf("%s",hotel_namee);
        printf("write feedback");
        scanf("%s",review_feedback);
